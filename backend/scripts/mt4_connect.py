#!/usr/bin/env python3
"""
MT4 Connection Script for Quantum Risk Coach Backend
Connects to MetaTrader 4 and retrieves account information
"""
...
def connect_to_mt4(server, login, password, sandbox=False):
    """
    Connect to MT4 terminal and get account information
    """
    try:
...
def main():
    parser = argparse.ArgumentParser(description='Connect to MT4 and get account info')
    ...
    # Attempt connection
    result = connect_to_mt4(args.server, args.login, args.password, sandbox)

#!/usr/bin/env python3
"""
MT5 History Script for Quantum Risk Coach Backend
...
def get_mt5_history(server, login, password, symbol=None, from_date=None, to_date=None, limit=100):
    """
...
def main():
    parser = argparse.ArgumentParser(description='Get MT5 trade history')

#!/usr/bin/env python3
"""
MT4 Account Info Script for Quantum Risk Coach Backend
Retrieves detailed account information from MetaTrader 4
"""
...
def get_mt4_account_info(server, login, password):
    """
    Get detailed account information from MT4
    """
    try:
...
def main():
    parser = argparse.ArgumentParser(description='Get MT4 account information')
    ...
    # Get account info
    result = get_mt4_account_info(args.server, args.login, args.password)

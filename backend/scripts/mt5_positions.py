#!/usr/bin/env python3
"""
MT5 Positions Script for Quantum Risk Coach Backend
...
def get_mt5_positions(server, login, password):
    """
...
def main():
    parser = argparse.ArgumentParser(description='Get MT5 open positions')
    ...
    # Get positions
    result = get_mt5_positions(args.server, args.login, args.password)

...
export const QuantumDesignDemo: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B0F1A] to-[#1A2233] p-6 space-y-8">
      ...
      <QuantumPanel variant="default" padding="lg" glow>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="space-y-2">
            <div className="h-16 bg-[#0B0F1A] rounded-lg border border-[rgba(45,244,255,0.2)]"></div>
            <p className="text-sm text-[#B2B2B2]">Primary Background</p>
            <p className="text-xs text-[#2DF4FF]">#0B0F1A</p>
          </div>
          <div className="space-y-2">
            <div className="h-16 bg-[#1A2233] rounded-lg border border-[rgba(45,244,255,0.2)]"></div>
            <p className="text-sm text-[#B2B2B2]">Secondary Background</p>
            <p className="text-xs text-[#2DF4FF]">#1A2233</p>
          </div>
          <div className="space-y-2">
            <div className="h-16 bg-[#2DF4FF] rounded-lg border border-[rgba(45,244,255,0.2)]"></div>
            <p className="text-sm text-[#B2B2B2]">Accent Glow</p>
            <p className="text-xs text-[#2DF4FF]">#2DF4FF</p>
          </div>
          <div className="space-y-2">
            <div className="h-16 bg-gradient-to-br from-[#2DF4FF] to-[#A34EFF] rounded-lg border border-[rgba(45,244,255,0.2)]"></div>
            <p className="text-sm text-[#B2B2B2]">Button Active</p>
            <p className="text-xs text-[#2DF4FF]">Gradient</p>
          </div>
        </div>
      </QuantumPanel>
      ...
      <QuantumPanel variant="elevated" padding="lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card variant="quantum">
            ...
            <CardContent>
              <p className="text-[#B2B2B2]">This card demonstrates the quantum design system with proper spacing and effects.</p>
            </CardContent>
          </Card>
      ...
      <QuantumPanel variant="default" padding="lg">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-[#F4F4F4]">Text Hierarchy</h3>
              <div className="space-y-2">
                <h1 className="text-4xl font-bold text-[#F4F4F4]">Heading 1</h1>
                <h2 className="text-3xl font-semibold text-[#F4F4F4]">Heading 2</h2>
                <h3 className="text-2xl font-medium text-[#F4F4F4]">Heading 3</h3>
                <p className="text-lg text-[#B2B2B2]">Body text with secondary color</p>
                <p className="text-sm text-[#B2B2B2] opacity-70">Small text for captions</p>
              </div>
            </div>

            <div className="space-y-4">
              <h3 className="text-lg font-medium text-[#F4F4F4]">Status Colors</h3>
              <div className="space-y-2">
                <p className="text-[#B6F080] font-medium">Profit/Positive Text</p>
                <p className="text-[#FF6F61] font-medium">Loss/Negative Text</p>
                <p className="text-[#2DF4FF] font-medium">Accent/Active Text</p>
                <p className="text-[#A34EFF] font-medium">Violet Accent Text</p>
                <p className="text-[#B2B2B2] font-medium">Neutral/Secondary Text</p>
              </div>
            </div>
          </div>
        </div>
